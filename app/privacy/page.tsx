...
export default function PrivacyPage() {
  return (
    <div className="container mx-auto px-4 py-16 max-w-4xl">
      <h1 className="text-4xl font-bold text-black mb-8">Privacy Policy and Terms of Service</h1>
      ...
      <div className="prose prose-lg max-w-none">
        ...
        <div className="mb-16">
          ...
          <section className="mb-8">
            <h3 className="text-2xl font-bold text-black mb-4">Introduction</h3>
          ...
          <section className="mb-8">
            <h3 className="text-2xl font-bold text-black mb-4">Information We Collect</h3>
            <p className="text-gray-700 mb-4">
          ...
          <section className="mb-8">
            <h3 className="text-2xl font-bold text-black mb-4">How We Use Your Information</h3>
          ...
          <section className="mb-8">
            <h3 className="text-2xl font-bold text-black mb-4">Information Sharing</h3>
            <p className="text-gray-700 mb-4">
          ...
          <section className="mb-8">
            <h3 className="text-2xl font-bold text-black mb-4">Data Security</h3>
            <p className="text-gray-700 mb-4">
          ...
          <section className="mb-8">
            <h3 className="text-2xl font-bold text-black mb-4">Your Rights</h3>
          ...
          <section className="mb-8">
            <h3 className="text-2xl font-bold text-black mb-4">Cookies</h3>
            <p className="text-gray-700 mb-4">
          ...
          <section className="mb-8">
            <h3 className="text-2xl font-bold text-black mb-4">Changes to This Policy</h3>
            <p className="text-gray-700 mb-4">
        ...
        <div className="mb-16">
          ...
          <section className="mb-8">
            <h3 className="text-2xl font-bold text-black mb-4">Agreement to Terms</h3>
            <p className="text-gray-700 mb-4">
          ...
          <section className="mb-8">
            <h3 className="text-2xl font-bold text-black mb-4">Use License</h3>
            <p className="text-gray-700 mb-4">
          ...
          <section className="mb-8">
            <h3 className="text-2xl font-bold text-black mb-4">Professional Use Only</h3>
            <p className="text-gray-700 mb-4">
          ...
          <section className="mb-8">
            <h3 className="text-2xl font-bold text-black mb-4">Account Responsibilities</h3>
          ...
          <section className="mb-8">
            <h3 className="text-2xl font-bold text-black mb-4">Orders and Payments</h3>
            <p className="text-gray-700 mb-4">
          ...
          <section className="mb-8">
            <h3 className="text-2xl font-bold text-black mb-4">Delivery and Service Area</h3>
            <p className="text-gray-700 mb-4">
          ...
          <section className="mb-8">
            <h3 className="text-2xl font-bold text-black mb-4">Product Information</h3>
            <p className="text-gray-700 mb-4">
          ...
          <section className="mb-8">
            <h3 className="text-2xl font-bold text-black mb-4">Prohibited Activities</h3>
          ...
          <section className="mb-8">
            <h3 className="text-2xl font-bold text-black mb-4">Limitation of Liability</h3>
            <p className="text-gray-700 mb-4">
          ...
          <section className="mb-8">
            <h3 className="text-2xl font-bold text-black mb-4">Indemnification</h3>
            <p className="text-gray-700 mb-4">
          ...
          <section className="mb-8">
            <h3 className="text-2xl font-bold text-black mb-4">Modifications</h3>
            <p className="text-gray-700 mb-4">

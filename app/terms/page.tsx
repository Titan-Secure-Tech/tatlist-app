  ...
  return (
    <div className="container mx-auto px-4 py-16 max-w-4xl">
      ...
      <div className="prose prose-lg max-w-none">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Professional Use Only</h2>
          <p className="text-gray-700 mb-4">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Account Responsibilities</h2>
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Orders and Payments</h2>
          <p className="text-gray-700 mb-4">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Delivery and Service Area</h2>
          <p className="text-gray-700 mb-4">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-black mb-4">Prohibited Activities</h2>

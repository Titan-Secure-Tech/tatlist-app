...
describe('Issue #19 - Unauthenticated User Access Control', () => {
  describe('Site Header Navigation', () => {
    it('hides Shop link from unauthenticated users', async () => {
      render(<SiteHeader />)

      // Wait for component to finish rendering and state updates
      await waitFor(() => {
    ...
    it('shows public navigation links to unauthenticated users', async () => {
      render(<SiteHeader />)

      // Wait for component state updates to complete
      await waitFor(() => {
    ...
    it('shows Sign In and Sign Up buttons to unauthenticated users', async () => {
      render(<SiteHeader />)
  ...
  describe('Access Control Validation', () => {
    it('requiresAuth flag is set for Shop navigation item', async () => {
    ...
    it('does not show product-related content to unauthenticated users', async () => {
      render(<SiteHeader />)
  ...
  describe('Mobile Navigation', () => {
    it('hides Shop from mobile menu for unauthenticated users', async () => {
      render(<SiteHeader />)

...
describe('Cart Page', () => {
  ...
  describe('Checkout', () => {
    ...
    it('handles checkout button click', async () => {
      ...
      expect(mockAlert).toHaveBeenCalledWith('Square payment integration coming soon!')
    })
  })
  ...
  describe('Responsive Design', () => {
    ...
    it('displays cart items in proper layout', () => {
      ...
      const cartContainer = screen.getByText('Test Item with Very Long Name That Should Wrap')

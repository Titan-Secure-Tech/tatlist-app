-- ============================================================
-- PRODUCTION MIGRATION FOR TATLIST
-- Execute this in Supabase Dashboard > SQL Editor
-- This will sync the production database with local schema
-- ============================================================
...
-- Ensure the trigger exists for auto-user creation
...
WHERE schemaname = 'public' 
  AND tablename IN ('users', 'products', 'orders', 'order_items', 'cart_items', 'favorites', 'inventory_lists', 'inventory_list_items', 'deliveries')
ORDER BY tablename;